...
export function getCliPath() {
  ...
  switch (os) {
    case "windows":
      return "%LOCALAPPDATA%\\MRnObrainer\\mrnobrainer-app.exe";
    case "macos":
      return "/Applications/MRnObrainer.app/Contents/MacOS/mrnobrainer-app";
    case "linux":
      return "/usr/local/bin/mrnobrainer-app";
    default:
      return "mrnobrainer-app";
  }
}
