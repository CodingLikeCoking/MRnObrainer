  ...
  try {
    ...
    await invoke("show_notification_panel", {
      payload: JSON.stringify({
        ...
        body: "you have 2h of local capture ready. open the dashboard, inspect the timeline, or ask ai about your day.",
        autoDismissMs: 20000,
        actions: [
          { label: "dashboard", action: "open_timeline", primary: true },
          { label: "assistant", action: "open_chat" },
        ],
      }),
    });
