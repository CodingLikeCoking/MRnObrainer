...
pub fn default_analytics_enabled() -> bool {
    !cfg!(feature = "oss-public")
}

pub fn default_audio_chunk_duration_secs() -> i32 {
...
pub fn default_audio_transcription_engine() -> &'static str {
    if cfg!(feature = "oss-public") {
...
"#.to_string(),
        ...
        Self {
            ...
            dev_mode: false,
            audio_transcription_engine: default_audio_transcription_engine().to_string(),
            #[cfg(target_os = "macos")]
            ...
            audio_chunk_duration: default_audio_chunk_duration_secs(),
            ...
            #[cfg(target_os = "windows")]
            show_screenpipe_shortcut: "Alt+Shift+O".to_string(),
            #[cfg(not(target_os = "windows"))]
            show_screenpipe_shortcut: "Shift+Super+O".to_string(),
            #[cfg(target_os = "windows")]
...
mod tests {
    ...
    fn test_public_defaults_disable_analytics() {
        assert_eq!(
            SettingsStore::default().analytics_enabled,
            default_analytics_enabled()
        );
    }

    #[test]
    fn test_public_defaults_use_shorter_audio_chunks() {
        assert_eq!(
