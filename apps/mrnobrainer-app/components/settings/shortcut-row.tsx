...
const SHORTCUT_LABELS: Record<string, string> = {
  showScreenpipeShortcut: "MRnObrainer dashboard",
  showChatShortcut: "AI chat",
  searchShortcut: "search",
  startRecordingShortcut: "start recording",
  stopRecordingShortcut: "stop recording",
  startAudioShortcut: "start audio recording",
  stopAudioShortcut: "stop audio recording",
};
...
const ShortcutRow = ({
    ...
    try {
      ...
      if (conflict) {
        toast({
          ...
          description: `this shortcut is already used by "${SHORTCUT_LABELS[conflict[0]] || conflict[0]}". choose a different combination.`,
          variant: "destructive",
        });
        return;
      }
      ...
      toast({
        ...
        description: `${SHORTCUT_LABELS[shortcut] || title} enabled`,
      });
  ...
  const handleDisableShortcut = async () => {
    toast({
      ...
      description: `${SHORTCUT_LABELS[shortcut] || title} disabled`,
    });
    updateSettings({
