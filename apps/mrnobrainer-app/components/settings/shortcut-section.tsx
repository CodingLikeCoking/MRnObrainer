  ...
  return (
    <div className="space-y-5">
      ...
      <div className="space-y-2">
        <ShortcutRow type="global" shortcut="showScreenpipeShortcut" title="toggle MRnObrainer dashboard" description="show/hide the MRnObrainer dashboard" value={settings.showScreenpipeShortcut} />
        ...
        <div className="flex items-center justify-between px-3 py-2.5 bg-card rounded-lg border border-border">
          <div className="flex items-center space-x-2.5">
            <div>
              ...
              <p className="text-xs text-muted-foreground">Overlay showing the MRnObrainer shortcut</p>
            </div>
          </div>
          <Switch
            id="shortcut-overlay"
