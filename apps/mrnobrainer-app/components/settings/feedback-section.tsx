      ...
      <div className="space-y-2">
        ...
        <div className="px-3 py-2.5 bg-card border border-border">
          <div className="flex items-center justify-between">
            ...
            <button
              onClick={() => open(MRNOBRAINER_GITHUB_DISCUSSIONS_URL)}
        ...
        <div className="px-3 py-2.5 bg-card border border-border">
          <div className="flex items-center justify-between">
            ...
            <button
              onClick={() => open(MRNOBRAINER_GITHUB_ISSUES_URL)}
              className="text-xs text-muted-foreground hover:text-foreground transition-colors duration-150"
            >
              open →
            </button>
        ...
        <div className="px-3 py-2.5 bg-card border border-border">
          <div className="flex items-center justify-between">
            ...
            <button
              onClick={() => open(MRNOBRAINER_RELEASES_URL)}
              className="text-xs text-muted-foreground hover:text-foreground transition-colors duration-150"
            >
              release downloads →
            </button>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">ask questions and discuss priorities</p>
              </div>
            </div>
            <button
              onClick={() => open(MRNOBRAINER_GITHUB_DISCUSSIONS_URL)}
