...
import { MRNOBRAINER_GITHUB_DISCUSSIONS_URL } from "@/lib/github-releases";
        ...
        <div className="space-y-2.5">
          ...
          >
            ...
            <div className="text-left flex-1 min-w-0">
              <div className="font-medium">MRnObrainer Pro — $39/mo</div>
          ...
          <Button
            ...
            onClick={async () => {
              ...
              await openUrl(MRNOBRAINER_GITHUB_DISCUSSIONS_URL);
              onOpenChange(false);
            }}
          >
