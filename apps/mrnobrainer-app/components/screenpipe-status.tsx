...
const HealthStatus = ({ className }: { className?: string }) => {
  ...
  const getStatusMessage = (
    ...
    if (status === "loading")
      return `${PRODUCT_NAME} is starting up. this may take a few minutes...`;
    ...
    if (issues.length === 0) return `${PRODUCT_NAME} is running smoothly`;
      ...
      <Dialog open={isOpen} onOpenChange={close}>
        ...
        >
          <DialogHeader className="flex flex-row items-center justify-between">
            <DialogTitle>{`${PRODUCT_NAME} status`}</DialogTitle>
                ...
                <div className="flex items-center gap-3 p-4 bg-destructive/10 border border-destructive/20 rounded-lg">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-destructive">
                      {`the ${PRODUCT_NAME} capture service is not running`}
                    </p>
                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-muted-foreground mb-4">
                          {`ensure ${PRODUCT_NAME} has the permissions it needs to keep capture running`}
                        </p>
