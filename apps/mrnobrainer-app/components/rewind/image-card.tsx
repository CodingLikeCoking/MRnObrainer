...
const FrameImage = ({ frameId, alt }: { frameId: number; alt: string }) => {
	...
	return (
		<div className="aspect-video overflow-hidden relative bg-black/[0.04] dark:bg-white/[0.03]">
			{isLoading && (
			...
			{hasError ? (
				...
				<img
					...
					alt={alt}
					className={cn(
						"h-full w-full object-contain p-1.5 transition-all duration-200 relative group-hover:scale-[1.02]",
