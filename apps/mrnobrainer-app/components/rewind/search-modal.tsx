    ...
    <div className="aspect-video bg-muted relative overflow-hidden">
      ...
      {hasError ? (
        ...
        <img
          ...
          alt={alt}
          className={cn(
            "w-full h-full object-contain bg-black/[0.04] p-1 transition-opacity dark:bg-white/[0.03]",
              ...
              <div className="flex flex-col gap-2">
                {(contentFilter === "all" ? uiEventResults.slice(0, 5) : uiEventResults).map((evt) => {
                  const EvtIcon = evt.event_type === "clipboard" ? ClipboardCopy
                    ...
                    : evt.event_type === "notification_received" ? MessageSquare
                    : Keyboard;
                  return (
                    <div
                      key={evt.id}
                      ...
                      <div className="flex items-start justify-between gap-3">
                        <div className="flex items-start gap-2 min-w-0">
                          ...
                          <div className="min-w-0">
                            ...
                            {(evt.device_name || evt.source_platform || evt.machine_id) && (
                              <p className="text-[11px] text-muted-foreground mt-0.5 truncate">
                                {[evt.device_name, evt.source_platform, evt.machine_id]
                                  .filter(Boolean)
                                  .join(" • ")}
