...
export function useTimelineKeyboard(opts: {
	...
	}, [enabled, selectionRange, sendSelectionToChat]);
	...
	}, [enabled, showSearchModal, resetFilters, setShowSearchModal]);
	...
	}, [enabled, currentFrame, isMac, showSearchModal]);
	...
	}, [enabled, showSearchModal, embedded, resetFilters, inSearchReviewMode, clearSearchHighlight, pausePlayback, selectedAppNameRef, selectedDeviceIdRef, setShowSearchModal]);
	...
	}, [enabled, frames, setCurrentFrame, showSearchModal, isPlaying, seekPlayback, pausePlayback, inSearchReviewMode, searchResultIndex, searchResults, hasSearchHighlight, dismissSearchHighlight, setCurrentIndex, findNextDevice, setIsArrowNav, arrowNavTimerRef, navigateToSearchResultRef]);
