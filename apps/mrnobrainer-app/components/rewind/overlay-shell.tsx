...
export function OverlayShell({ defaultSection = "home" }: OverlayShellProps) {
                ...
                <div className="flex h-[calc(100%-2rem)] w-[960px] max-w-[calc(100%-2rem)] overflow-hidden border border-border bg-background" onClick={(event) => event.stopPropagation()}>
                  ...
                  <div className="flex min-w-0 flex-1 flex-col">
                    <div className="flex flex-shrink-0 items-center border-b border-border px-6 py-3">
                      ...
                      <button onClick={closeModal} className="ml-auto text-xs text-muted-foreground transition-colors hover:text-foreground">
                        Close
                      </button>
                    </div>
