...
## Key Directories
- `apps/mrnobrainer-app/` - Desktop app (Tauri + Next.js)
...
- Config: `apps/mrnobrainer-app/src-tauri/tauri.conf.json` → `bundle.macOS.signingIdentity`
...
- for this repo, default to direct `main`-branch development; do not create feature branches or `codex/*` branches unless the user explicitly asks for one
