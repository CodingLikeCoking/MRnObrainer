...
**Sync MRnObrainer or Screenpipe-compatible data to remote AI agents.**

One-liner to sync daily summaries to a remote server, for example
[OpenClaw](https://github.com/openclaw/openclaw). Uses Claude Code CLI
...
1. **OpenClaw** has native cron that reads files and sends digest:
...
All processing happens locally. Screen data never leaves your machine
unless you explicitly sync summaries to a remote.
...
[docs/CHANGE_RULES.md](../../docs/CHANGE_RULES.md). Any public repro,
screenshot, or sample output must be redacted before sharing.
