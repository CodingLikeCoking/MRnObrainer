...
fn install_onnxruntime() {
    ...
    let target_dir =
        Path::new("../../apps/mrnobrainer-app/src-tauri/onnxruntime-win-x64-1.19.2");
    ...
    println!("cargo:rustc-link-search=native=../../apps/mrnobrainer-app/src-tauri/onnxruntime-win-x64-1.19.2/lib");
}
